...
angular.module("meecarros").controller("carController", ["$scope", "$state", "$rootScope", "$stateParams", "personService", carController]);

function carController($scope, $state, $rootScope, $stateParams, personService) {
    ...
    function fillIn(id) {
        console.log("carrega o carro de id: " + id);
    };

    function fillInPersons() {
        personService.getCarsModels()
