...
public class Module extends AbstractModule {
    ...
    public void configure() {
        this.bind(MetricRegistry.class).toProvider(MetricRegistryProvider.class).asEagerSingleton();
        this.bind(ICarRepository.class).to(JPACarRepository.class).asEagerSingleton();
    }
}
